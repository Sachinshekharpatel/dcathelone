      ...
      <div className="px-4 py-3 2xl:px-16 xl:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <a href="/" className="ml-1 cursor-pointer md:ml-6 lg:ml-12">
              <svg
                viewBox="0 0 188 28"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-32 sm:w-40 md:w-40  lg:w-40"
              >
                <path
          ...
          <div className="relative hidden md:block">
            <p className=" text-center  text-12 lg:text-14 whitespace-nowrap text-grey-900 font-roboto">
              Delivery Location
            </p>

            <div className="flex justify-center">
              <span className="text-14 lg:text-16 font-bold text-blue-400">
                486001
              </span>
              <button
                type="button"
          ...
          <div className="flex items-center space-x-0.5">
            <a className="mx-1" href="/">
              <div className="relative flex flex-col group">
                ...
                <p className="text-center font-semibold text-6 lg:text-8">SignIn</p>
              </div>
            </a>
            <a href="/store" className="mx-5">
              <div className="relative flex flex-col group">
                ...
                >
                 ...
                 <p className="text-center font-semibold text-6 lg:text-8">Store</p>
              </div>
            </a>
            <a className="mx-5" href="/wishlist">
              <div className="">
                ...
                <p className="text-center font-semibold text-6 lg:text-8">Wishlist</p>
              </div>
            </a>
